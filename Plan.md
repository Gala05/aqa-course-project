...
18. Проверка на предыдущий месяц. Кредит по данным карты. Карта APPROVED. Месяц предыдущий, год текущий, остальные данные валидные.
    ...
    CVC/CVV "147"  
    Нажать на кнопку Продолжить  
    ООжидаемый результат: Возле поля "Месяц" выходит сообщение "Неверно указан срок действия карты"
19. Проверка на невалидный месяц. Оплата по карте. Карта APPROVED. Месяц 13, остальные данные валидные.
    На странице http://localhost:8080/ нажимаем кнопку "Купить", вводим следующие данные
    Номер карты "1111 2222 3333 4444"  
    Месяц "13"  
    Год "24"  
...
28. Проверка на спецсимволы в поле Владелец. Кредит по данным карты. Карта APPROVED. Владелец «%vanov Ivan», 
    ...
    Нажать на кнопку Продолжить  
    Ожидаемый результат: Возле поля "Владелец" выходит сообщение "Неверный формат"
29. Проверка ввода одной цифры в поле «CVC/CVV». Оплата по карте. Карта APPROVED. CVC/CVV «1», остальные данные 
    валидные.
    На странице http://localhost:8080/ нажимаем кнопку "Купить", вводим следующие данные
    Номер карты "1111 2222 3333 4444"  
    Месяц "11"  
...
30. Проверка ввода одной цифры в поле «CVC/CVV». Кредит по данным карты. Карта APPROVED. CVC/CVV «1», остальные данные 
   валидные.
    На странице http://localhost:8080/ нажимаем кнопку "Купить в кредит", вводим следующие данные
    Номер карты "1111 2222 3333 4444"  
    Месяц "11"   
    ...
    Нажать на кнопку Продолжить  
    Ожидаемый результат: Возле поля "CVC/CVV" выходит сообщение "Неверный формат"
31. Проверка ввода 11 цифр в поле «Номер карты». Оплата по карте. 
    На странице http://localhost:8080/ нажимаем кнопку "Купить", вводим следующие данные
...
32. Проверка ввода 11 цифр в поле «Номер карты». Кредит по данным карты.   
    На странице http://localhost:8080/ нажимаем кнопку "Купить в кредит", вводим следующие данные
    Номер карты "1111 2222 3333 444"  
    Месяц "11"  
    Год "24"  
