...
public class CreditPurchasePage {
    ...
    public static final SelenideElement buttonPay = $x("//span[text()='Купить в кредит']//ancestor::button");
    public static final SelenideElement cardPayment = $x("//h3[contains(text(), 'Кредит по данным карты')]");
    ...
    public static void fillingFieldsCreditPage(DataHelper.CardData card) {
